...
//        MongoClientURI connectionString = new MongoClientURI("mongodb+srv://admin:admin@clusterkorisnika-rtz4a.mongodb.net/test?retryWrites=true&w=majority");
...
//
//        kolekcijaKorisnika.save(new Korisnik(UUID.randomUUID(), "MONGODB KORISNIK"));
//
